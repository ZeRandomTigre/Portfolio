	...
	namespace Pong
	{
		...
		public class PongPhysics : Sce.PlayStation.HighLevel.Physics2D.PhysicsScene
		{
			...
			public enum BODIES { Ball = 0, Player1, Player2,  LeftBumper, RightBumper, Ai };
			...
			public PongPhysics ()
			{
				...
				this.NumBody = 6; // Ball, 3 paddles, 2 bumpers
				...
				float p2X = ((m_screenWidth/2f)/PtoM);
				float p2Y = (m_screenHeight - PADDLEHEIGHT/2 - 10f)/ PtoM;
				this.SceneBodies[5].Position = new Vector2(p2X,p2Y);
