...
namespace Pong
{
	...
	{
		// variables
        private const string DEFAULT_HOST = "whois.net.dcs.hull.ac.uk";
        private string host = "localhost";
        private int port = 43;
        private string streamRead;
        private string protocolType = "whois";
        private bool hostChange = false;
        private string[] sections;
        private string userName = "";
        private string location = "";
		public string message = "";
		public string responseMessage = "";
		public string gameHighscore = "";
	                ...
	                case "whois":
	                   ...
	                   // Console.WriteLine();
	                    ...
	                    switch (streamRead)
	                    {
	                        default:
	                            // location request
								responseMessage = userName + " is " + streamRead;
								gameHighscore = streamRead;
	                            break;
	                        case "OK":
	                            // location change
								responseMessage = userName + " location changed to be " + location;
	                            break;
	                        case "ERROR: no entries found":
	                            // no entries found
								responseMessage = "ERROR: no entries found";
	                            break;
	                    }
