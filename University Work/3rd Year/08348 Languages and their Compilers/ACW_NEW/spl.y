...
enum ParseTreeNodeType { PROGRAM, BLOCK, DECLARATION_BLOCK, IDENTIFIER_LIST, TYPE_T, STATEMENT_LIST, STATEMENT, ASSIGNMENT_STATEMENT,
							...
							TERM, VALUE, CONSTANT, NUMBER_CONSTANT, NUMBER_VALUE, ID_VALUE, CHAR_VALUE};
...
constant : number_constant
			...
			| CHAR
			{
				$$ = create_node($1, CHAR_VALUE, NULL, NULL, NULL);
			}
			;
...
number_constant : NUMBER
					...
					| MINUS NUMBER 
					{
						$$ = create_node($2, NUMBER_VALUE, NULL, NULL, NULL);
					}
...
void PrintTree(TERNARY_TREE t)
{
	...
	if (t->item != NOTHING)
	{
		...
		else if (t->nodeIdentifier == ID_VALUE || t->item == CHAR_VALUE)
		{
